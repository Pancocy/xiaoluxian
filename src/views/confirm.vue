...
//api
import { settlement ,alipayOrder , queryAlipay} from '../utils/api/order'
...
//生命周期
onBeforeMount(()=>{
  settlement(cartStore.cartList).then(res=>{
  ...
  queryAlipay({
    ...
    if( res.meta.code=='200' ){
      ...
      createToken().then(res=>{
        deleteShopCars(cartStore.selected,res.data.token);
      })
    }
  })
}
