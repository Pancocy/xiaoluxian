			...
			<div class='play-right'>
              ...
              <template #label>
	            ...
	            <div class="course-container">
	              ...
	              <div class="courseDesc">{{chapterInfo.description}}</div>
	              <div class="courseImg">
	              ...
	              <div class="teacher" v-if="true">
	                <div class="teacherAvt">
	                  <img :src="teacherInfo.teacherAvatar" alt="" />
	                </div>
	                <div class="teacherInfo">
	                  <div class="teacherName">{{teacherInfo.teacherName}}</div>
	                  <div class="teacherTag">{{teacherInfo.tags}}</div>
	                </div>
	              </div>
              ...
              <template #label>
	            ...
	            <div class="chapter-container">
	              <dl class="list" v-for="item in Chapters" :key="item.id">
...
//api
import { player } from '../utils/api/lesson'
//引入vue3视频控件
import vue3Video from 'vue3-video-play'
//视频的数据
...
onBeforeMount(()=>{
    ...
    //教师信息
    teacherInfo.value=res.data.courseInfo.bizCourseTeacher
    //课程章节和小节
    Chapters.value = res.data.courseInfo.bizCourseChapters;
    //课程视频url
    options.src = res.data.playInfo.playInfoList[1].playURL
    })
})
</script>
